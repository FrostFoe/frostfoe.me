                ...
                <div className="mx-auto px-6 max-w-7xl md:px-12">
                    ...
                    <div className="-mx-6 relative mt-8 sm:mt-12 max-w-xl sm:mx-auto">
                        ...
                        <Swiper
                            ...
                            className="proofSlides pb-6"
                        >
                            <SwiperSlide className="px-6 pt-2 pb-12">
                                ...
                                <div className="card variant-outlined p-9">
                                    <div>
                                        <div className="h-12 w-fit mx-auto">
                                            <svg className="h-8 my-auto w-fit" xmlnsX="ns_extend;" xmlnsI="ns_ai;" xmlnsGraph="ns_graphs;" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 251.8 48" style={{enableBackground:'new 0 0 251.8 48'}} xmlSpace="preserve">
                                                <g>
